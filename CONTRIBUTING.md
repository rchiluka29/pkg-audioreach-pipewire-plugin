# Contributing to pkg-audioreach-pipewire-plugin
...
1. [Fork](https://github.com/qualcomm-linux/pkg-audioreach-pipewire-plugin/fork) and clone the repository.

    ```bash
    git clone https://github.com/qualcomm-linux/pkg-audioreach-pipewire-plugin.git
    ```
...
1. Create an upstream `remote` to make it easier to keep your branches up-to-date:
    ...
    ```bash
    git remote add upstream https://github.com/qualcomm-linux/pkg-audioreach-pipewire-plugin.git
    ```
...
1. [Submit a pull request](https://github.com/qualcomm-linux/pkg-audioreach-pipewire-plugin/pulls) from your branch to `main`.
